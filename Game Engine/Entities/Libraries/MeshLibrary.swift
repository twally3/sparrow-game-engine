...
class Cube_CustomMesh: Mesh {
    override func createMesh() {
        addVertex(position: SIMD3<Float>(-0.5,-0.5,-0.5), normal: SIMD3<Float>(-1, 0, 0))
        addVertex(position: SIMD3<Float>(-0.5,-0.5, 0.5), normal: SIMD3<Float>(-1, 0, 0))
        addVertex(position: SIMD3<Float>(-0.5, 0.5, 0.5), normal: SIMD3<Float>(-1, 0, 0))
        addVertex(position: SIMD3<Float>(-0.5, 0.5,-0.5), normal: SIMD3<Float>(-1, 0, 0))
        ...
        //TOP
        addVertex(position: SIMD3<Float>( 0.5, 0.5, 0.5), normal: SIMD3<Float>(0, 1, 0))
        addVertex(position: SIMD3<Float>( 0.5, 0.5,-0.5), normal: SIMD3<Float>(0, 1, 0))
        addVertex(position: SIMD3<Float>(-0.5, 0.5,-0.5), normal: SIMD3<Float>(0, 1, 0))
        addVertex(position: SIMD3<Float>(-0.5, 0.5, 0.5), normal: SIMD3<Float>(0, 1, 0))
        ...
        //BACK
        addVertex(position: SIMD3<Float>(-0.5,-0.5,-0.5), normal: SIMD3<Float>(0, 0, -1))
        addVertex(position: SIMD3<Float>(-0.5, 0.5,-0.5), normal: SIMD3<Float>(0, 0, -1))
        addVertex(position: SIMD3<Float>( 0.5, 0.5,-0.5), normal: SIMD3<Float>(0, 0, -1))
        addVertex(position: SIMD3<Float>( 0.5,-0.5,-0.5), normal: SIMD3<Float>(0, 0, -1))
